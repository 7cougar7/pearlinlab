...
public class LevelGeneration : MonoBehaviour
{
	...
	// public GameObject parentObj = new GameObject("parentMap");
	...
	// void makechild(){
	// 	GameObject[] objs =  GameObject.FindGameObjectsWithTag ("things to group");
...
{
	public int tileDepthInVertices, tileWidthInVertices;
